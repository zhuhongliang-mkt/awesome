...
- **[zhuhongliang-mkt/mrpack-converter-site](https://github.com/zhuhongliang-mkt/mrpack-converter-site)** ([Website](https://mrpackconverter.com)) - A browser-based toolkit for converting, inspecting, and troubleshooting Modrinth `.mrpack` files.
...
- **[creeperkatze/modfolio](https://github.com/creeperkatze/modfolio)** ([Website](https://modfolio.creeperkatze.dev)) - A flexible, reusable and fast embed generator for all things Modrinth. Get styled details about a user, project, organization or collection.
